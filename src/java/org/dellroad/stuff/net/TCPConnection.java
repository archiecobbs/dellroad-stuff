 ...
 */
class TCPConnection implements SelectorSupport.IOHandler {
...
// Constructors
    ...
    public TCPConnection(TCPNetwork network, String peer, SocketChannel socketChannel) throws IOException {
