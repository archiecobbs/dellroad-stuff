 ...
 * <li>An AOP aspect that allows {@link org.dellroad.stuff.vaadin8.VaadinConfigurable @VaadinConfigurable}
 ...
 * Key classes include:
 * <ul>
 *  <li>{@link org.dellroad.stuff.vaadin8.SpringVaadinServlet} associates a Spring application context
 *      with each "Vaadin application" instance (i.e., each {@link com.vaadin.server.VaadinSession}) using
 *      the {@link org.dellroad.stuff.vaadin8.SpringVaadinSessionListener} class (which does the bulk of the work).
 ...
 *  <li>An AOP aspect that works on {@link org.dellroad.stuff.vaadin8.VaadinConfigurable @VaadinConfigurable} beans,
 *      allowing them to be autowired by the Spring application context associated with the current Vaadin application
 *      instance by {@link org.dellroad.stuff.vaadin8.SpringVaadinServlet} (note: <i>not</i> just the parent context).
 *      Arbitrary beans get autowired into the Vaadin application's context at the time of construction.</li>
 *  <li>{@link org.dellroad.stuff.vaadin8.VaadinApplicationScope}, which adds a custom Spring scope so you can define application
 ...
 *      the subclass {@link org.dellroad.stuff.vaadin8.VaadinApplicationListener} supports listeners for Spring
 ...
 *  <li>The {@link org.dellroad.stuff.vaadin8.VaadinApplication} class can serve as an application-wide singleton
 ...
 * and <a href="https://github.com/archiecobbs/dellroad-stuff-vaadin-spring-demo3/tree/vaadin8">sample code is available on GitHub</a>.
 *
 * @see org.dellroad.stuff.vaadin8.SpringVaadinServlet
 * @see org.dellroad.stuff.vaadin8.VaadinConfigurable
 * @see org.dellroad.stuff.vaadin8.SpringVaadinSessionListener
 * @see org.dellroad.stuff.vaadin8.VaadinApplicationScope
 * @see org.dellroad.stuff.vaadin8.VaadinExternalListener
 * @see org.dellroad.stuff.vaadin8.VaadinApplicationListener
