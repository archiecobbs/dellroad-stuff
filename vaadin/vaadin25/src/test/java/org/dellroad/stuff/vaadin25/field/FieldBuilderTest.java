...
package org.dellroad.stuff.vaadin25.field;
...
import org.dellroad.stuff.vaadin25.data.EnumDataProvider;
import org.dellroad.stuff.vaadin25.grid.GridColumn;
...
public class FieldBuilderTest extends TestSupport {
    ...
    // Check field1
        ...
        Assert.assertTrue(field1.getSuffixComponent() instanceof Span);
        ...
        Assert.assertEquals(field1.getAriaLabel(), Optional.of("my aria label"));
        ...
        Assert.assertTrue(field1.getPrefixComponent() instanceof Span);
        Assert.assertTrue(field1.getHelperComponent() instanceof Span);
...
// Classes
    ...
    public abstract class Foo {
        ...
        @FieldBuilder.TextArea(
          ...
          width = "60px",
          prefixComponent = Span.class,
          helperComponent = Span.class,
