...
package org.dellroad.stuff.vaadin25.grid;
...
import org.dellroad.stuff.vaadin25.util.SelfRenderer;
...
public class GridColumnTest extends TestSupport {
    ...
    public void testGridColumns() throws Exception {
        ...
        Assert.assertTrue(col1.getPartNameGenerator() instanceof MyPartNameGenerator);
        ...
        Assert.assertEquals(col2.getPartNameGenerator(), col3.getPartNameGenerator());
...
// Classes
    ...
    public abstract static class Foo {
        ...
        @GridColumn(
          ...
          autoWidth = false,
          partNameGenerator = MyPartNameGenerator.class,
    ...
    public static class MyRenderer extends ComponentRenderer<Span, Foo> {
    ...
    @SuppressWarnings("serial")
    public static class MyEditorComponent implements SerializableFunction<Foo, Span> {
        @Override
        public Span apply(Foo foo) {
            return new Span();
        }
    }

    @SuppressWarnings("serial")
    public static class MyPartNameGenerator implements SerializableFunction<Foo, String> {
        @Override
