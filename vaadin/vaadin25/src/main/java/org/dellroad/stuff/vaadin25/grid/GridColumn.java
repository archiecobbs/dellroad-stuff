...
/**
 * Declare a {@link Grid.Column} to be auto-generated by a {@link GridColumnScanner}.
 *
 ...
 *
 * <p>
 * This annotation annotates methods in a model class {@code T} that backs a {@link Grid Grid&lt;T&gt;}. When the
 * class is scanned by a {@link GridColumnScanner}, each annotation results in a corresponding {@link Grid.Column}
 * being added to the {@link Grid} under construction, configured according to the various annotation properties.
 *
 * <p>
 ...
 *
 * <p>
 * By default, the method's return value is used to render the column by simple conversion to a {@link String}.
 * Custom rendering is possible by specifying a {@link #renderer}, or by having the method return a {@link Component}
 * directly; see {@link #renderer} for details;
 *
 * <p>
 * Some examples:
 ...
 *     <b>&#64;GridColumn(header = "DOB", sortable = true, renderer = MyDobRenderer.class)</b>
 *     public LocalDate getDateOfBirth() { ... }
 *
 *     // Custom rendering based on the entire backing object
 *     <b>&#64;GridColumn(header = "✔︎", renderer = SelectedRenderer.class)</b>
 ...
 * <ul>
 *  <li>Annotated methods must be instance methods taking zero parameters; annotations on other methods are ignored.
 *  <li>Protected, package private, and private methods are supported (assuming they are accessible).
 *  <li>{@link GridColumn &#64;GridColumn} annotations declared in super-types (including interfaces) are supported
 ...
 *      to "override" which method supplies a given property.
 *  <li>If the method returns a sub-type of {@link Component}, then by default a {@link SelfRenderer} is assumed.
 *      This lets you define a method that directly returns the {@link Component} to display.
 *  <li>If the annotated methods return {@code void} or {@link Void}, then a {@link #renderer} is required
 *      and it must have a default constructor.
 *  <li>Columns will be ordered first by {@link #order}, then by property name.
 * </ul>
 *
...
public @interface GridColumn {
     ...
     * if this property is specified, {@link Grid#addColumn(Renderer)} is used to create the column using an
     * instance of the specified renderer type.
     *
     * <p>
     ...
     *
     * <p>
     * If the annotated method returns {@code void} or {@link Void}, then this property must specify a custom
     * renderer type having a default constructor.
     *
     * <p>
     * Otherwise, the custom renderer type can have either a default constructor or a constructor taking a {@link ValueProvider}.
     * In the former case, the renderer accepts the model object backing the entire row, not the return value
     * from the method. In the latter case, the given {@link ValueProvider} provides access to the method's return
     * value (by invoking the method on demand).
     *
    ...
    /**
     * Get the CSS part name generator class.
     *
     * @return column comparator
     * @see Grid.Column#setPartNameGenerator
     */
    @SuppressWarnings("rawtypes")
    Class<? extends SerializableFunction> partNameGenerator() default SerializableFunction.class;
    ...
    /**
     * Get the column footer part name.
     *
     * @return column footer part name
     * @see Grid.Column#setFooterPartName(String)
     */
    String footerPartName() default "";
    ...
    /**
     * Get the frozen-to-end setting.
     *
     * @return column frozen-to-end setting
     * @see Grid.Column#setFrozenToEnd
     */
    ...
    /**
     * Get the column header part name.
     *
     * @return column header part name
     * @see Grid.Column#setHeaderPartName(String)
     */
    String headerPartName() default "";

    /**
     * Get whether column should be announced as a row header.
     *
     * @return whether column is a row header
     * @see Grid.Column#setRowHeader
     */
    boolean rowHeader() default true;
