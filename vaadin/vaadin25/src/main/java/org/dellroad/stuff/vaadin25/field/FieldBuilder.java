...
// EVERYTHING BELOW THIS LINE IS GENERATED
    ...
    public @interface Checkbox {
         ...
         */
        com.vaadin.flow.component.checkbox.CheckboxVariant[] addThemeVariants() default {};
    ...
    public @interface ComboBox {
        ...
        /**
         * Get the value desired for the {@code filterTimeout} property.
         *
         * @return desired {@code filterTimeout} property value
         * @see com.vaadin.flow.component.combobox.ComboBoxBase#setFilterTimeout(int)
         */
