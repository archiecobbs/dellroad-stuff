...
import org.dellroad.stuff.vaadin23.data.EnumDataProvider;
...
// EVERYTHING BELOW THIS LINE IS GENERATED
    ...
    public @interface DateTimePicker {
         ...
         *
         * @return zero or more theme variants to add
         * @see com.vaadin.flow.component.datetimepicker.DateTimePicker#addThemeVariants(com.vaadin.flow.component.datetimepicker.DateTimePickerVariant[])
         */
